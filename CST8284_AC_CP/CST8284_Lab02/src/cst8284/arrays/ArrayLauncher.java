...
//			System.out.print(oneDimensionalArray[i] + "    ");  
			System.out.print(value + "    "); //rewritten the existing code as the equivalent enhanced for loop
		}
	...
	public static void display2DArrayOfPrimitives() {
		...
		int[][][] threeDimensionalArray = new int[][][] { { { 1, 2, 3 }, { 2, 4, 6 } },{ { 7, 8, 9 }, { 10, 11, 12 } } };
//Question2: add a third dimension to the current 2D array of objects		
...
//		twoDimensionalArray[1][1] = twoDimensionalArray[0][1];
	}
